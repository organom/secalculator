...
namespace enenra.ArmorBalance
{
    ...
    {
        public const float lightArmorLargeDamageMod = 0.25f;
        public const float lightArmorLargeDeformationMod = 0.25f;
        public const float lightArmorSmallDamageMod = 0.25f;
        public const float lightArmorSmallDeformationMod = 0.25f;

        public const float heavyArmorLargeDamageMod = 0.333f;
        public const float heavyArmorLargeDeformationMod = 0.333f;
        public const float heavyArmorSmallDamageMod = 0.333f;
        public const float heavyArmorSmallDeformationMod = 0.333f;
